...
#if 0
// Direct reading of UM10470 Table 76
#define IOCON_P0_15 (*((volatile uint32_t *) 0x4002C03C)
#define IOCON_P0_16 (*((volatile uint32_t *) 0x4002C040)
#define IOCON_P0_17 (*((volatile uint32_t *) 0x4002C044)
#define IOCON_P0_18 (*((volatile uint32_t *) 0x4002C048)
#endif

// Paraphrased from https://github.com/mikef5410/lpcopen
#define LPC_IOCON_BASE (0x4002C000)
typedef struct {volatile uint32_t p[5][32];} LPC_IOCON_T;
